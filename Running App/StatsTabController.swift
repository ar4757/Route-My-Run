...
/*class StatsTabController: UIPageViewController {
...
extension StatsTabController: UIPageViewControllerDataSource, UIPageViewControllerDelegate {
...
class StatsTabController: UIPageViewController {
    ...
    override func viewDidLoad() {
        ...
        if let feedTabController = orderedViewControllers.first {
            setViewControllers([feedTabController],
                               direction: .forward,
                               animated: true,
                               completion: nil)
            //self.title = "Duration"
...
extension StatsTabController: UIPageViewControllerDataSource {
...
extension StatsTabController: UIPageViewControllerDelegate {
