...
//  Running App
//
//  Created by Andrew Ratz on 2/17/19.
...
class MapSelectViewController: UIViewController, MKMapViewDelegate, CLLocationManagerDelegate {
    ...
    @IBAction func doneButton(_ sender: UIButton) {
        if (annotation != nil) {
            ...
            if (starting == true) {
                //If round trip
                if (presenterChild.roundTripSwitchValue.isOn == true) {
